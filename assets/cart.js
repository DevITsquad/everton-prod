class Cart extends HTMLElement {
  ...
  swapInNewContent(t) {
    ...
    const mayAlsoLikeBlock = document.querySelector(".container_cp")
    itemsInCart.forEach(itemInCart => {
      ...
      if (counterToHideBar === mayAlsoLikeItems.length) {
        mayAlsoLikeBlock.style = "display:none;"
      }
    })
  }
  swapInImages(a, t) {
